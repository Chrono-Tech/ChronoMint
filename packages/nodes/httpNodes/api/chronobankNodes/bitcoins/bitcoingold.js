...
import { BLOCKCHAIN_BITCOIN_GOLD } from '@chronobank/core/dao/constants'
...
export const requestSubscribeWalletByAddress = (address) => (dispatch) => {
  const action = {
    type: 'REQ/MIDDLEWARE/BITCOIN_GOLD/POST/SUBSCRIBE',
    payload: {
...
export const requestUnubscribeWalletByAddress = (address) => (dispatch) => {
  const action = {
    type: 'REQ/MIDDLEWARE/BITCOIN_GOLD/DELETE/UNSUBSCRIBE',
    payload: {
      blockchain: BLOCKCHAIN_BITCOIN_GOLD,
      request: {
        method: 'DELETE',
...
export const requestBalanceByAddress = (address) => (dispatch) => {
  const action = {
    type: 'REQ/MIDDLEWARE/BITCOIN_GOLD/GET/BALANCE',
    payload: {
      blockchain: BLOCKCHAIN_BITCOIN_GOLD,
      request: {
        method: 'GET',
...
export const requestUtxoByAddress = (address) => (dispatch) => {
  const action = {
    type: 'REQ/MIDDLEWARE/BITCOIN_GOLD/GET/UTXO',
    payload: {
      blockchain: BLOCKCHAIN_BITCOIN_GOLD,
      request: {
        method: 'GET',
...
export const requestSendRawTransaction = (rawTx) => (dispatch) => {
  const action = {
    type: 'REQ/MIDDLEWARE/BITCOIN_GOLD/POST/SEND_RAW_TRANSACTION',
    payload: {
      blockchain: BLOCKCHAIN_BITCOIN_GOLD,
      request: {
        method: 'POST',
...
export const requestTransactionsHistoryByAddress = (address, skip = 0, offset = TXS_PER_PAGE) => (dispatch) => {
  const action = {
    type: 'REQ/MIDDLEWARE/BITCOIN_GOLD/GET/TRANSACTIONS_HISTORY',
    payload: {
      blockchain: BLOCKCHAIN_BITCOIN_GOLD,
      request: {
        method: 'GET',
...
export const requestTransactionByHash = (txHash) => (dispatch) => {
  const action = {
    type: 'REQ/MIDDLEWARE/BITCOIN_GOLD/GET/TRANSACTION_BY_HASH',
    payload: {
      blockchain: BLOCKCHAIN_BITCOIN_GOLD,
      request: {
        method: 'GET',
...
export const requestEstimateFeeRate = () => (dispatch) => {
  const action = {
    type: 'REQ/MIDDLEWARE/BITCOIN_GOLD/GET/ESTIMATE_FEE_RATE',
    payload: {
      blockchain: BLOCKCHAIN_BITCOIN_GOLD,
      request: {
        method: 'GET',
...
export const requestBlocksHeigh = () => (dispatch) => {
  const action = {
    type: 'REQ/MIDDLEWARE/BLOCKCHAIN_BITCOIN_GOLD/GET/BLOCKS_HEIGHT',
    payload: {
      blockchain: BLOCKCHAIN_BITCOIN_GOLD,
      request: {
        method: 'GET',
