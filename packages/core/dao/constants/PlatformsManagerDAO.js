...
export const EVENT_PLATFORM_ATTACHED = 'PlatformAttached'
export const EVENT_PLATFORM_DETACHED = 'PlatformDetached'
export const EVENT_PLATFORM_REQUESTED = 'PlatformRequested'
