...
const DASH_MAINNET_NODE = axios.create({ baseURL: 'https://explorer.bitcoingold.org/insight-api', timeout: 10000 })
const DASH_TESTNET_NODE = axios.create({ baseURL: 'https://tbcc.blockdozer.com/insight-api', timeout: 10000, withCredentials: false })
...
export default class BitcoinMiddlewareService {
  static service = {
    ...
    [BLOCKCHAIN_DASHCOIN]: {
      ...
      dashcoin_testnet: DASH_TESTNET_NODE,
    },
    [BLOCKCHAIN_LITECOIN]: {
