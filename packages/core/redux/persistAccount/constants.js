...
export const PERSIST_ACCOUNT_SET_LOCALE = 'persistAccount/SET_LOCALE'
export const PERSIST_ACCOUNT_SIGNATURES_LOADING = 'persistAccount/SIGNATURES_LOADING'
export const PERSIST_ACCOUNT_SIGNATURES_RESET_LOADING = 'persistAccount/SIGNATURES_RESET_LOADING'
