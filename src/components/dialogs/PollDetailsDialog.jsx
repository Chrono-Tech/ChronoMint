                  ...
                  <div styleName='entry'>
                    ...
                    <div styleName='entryValue'>
                      {details.voteLimitInTIME === null
                        ? (<i>Unlimited</i>)
                        : <TokenValue value={details.voteLimitInTIME} noRenderPrice precision={2} />
                      }
                    </div>
                  </div>
                  <div styleName='entry'>
                    <div styleName='entryLabel'><Translate value={prefix('receivedVotes')} />:</div>
                    <div styleName='entryValue'><TokenValue value={details.received} noRenderPrice precision={2} /></div>
                  </div>
                  <div styleName='entry'>
                        ...
                        {entries.map((item, index) => (
                          <div styleName='legendItem' key={index}>
                            ...
                            <div styleName='itemTitle'>
                              ...
                              <b><TokenValue noRenderPrice value={item.count} precision={2} /></b>
                            </div>
                          </div>
                        ))}
                      </div>
