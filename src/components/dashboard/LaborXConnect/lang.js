...
export default {
  en: {
    connectForm: {
      ...
      downloadCustomNode: 'Download Custom Node',
      parityTitle: 'Parity 2.8 Node Downloads',
      enterDelegateAddress: 'Enter Delegate Address',
      delegateAddressTitle: 'Describe what the heck user should do here.',
      startMining: 'Start Mining',
      startMiningTitle: 'Describe how to start mining.',
      done: 'Done',
    },
