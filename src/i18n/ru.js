...
export default {
  ...
  tx: {
    ...
    pluralTxWarning: 'Внимание: это многоступенчатая транзакция. Не закрывайте окно браузера до завершения всех шагов или отмените транзакцию. Смайненые транзакции необратимы.',
