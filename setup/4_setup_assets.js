const ChronoBankPlatform = artifacts.require('chronobank-smart-contracts/build/contracts/ChronoBankPlatform.sol')
const ChronoBankPlatformEmitter = artifacts.require('chronobank-smart-contracts/build/contracts/ChronoBankPlatformEmitter.sol')
const EventsHistory = artifacts.require('chronobank-smart-contracts/build/contracts/EventsHistory.sol')
const ChronoBankAssetProxy = artifacts.require('chronobank-smart-contracts/build/contracts/ChronoBankAssetProxy.sol')
const ChronoBankAssetWithFeeProxy = artifacts.require('chronobank-smart-contracts/build/contracts/ChronoBankAssetWithFeeProxy.sol')
const ChronoBankAsset = artifacts.require('chronobank-smart-contracts/build/contracts/ChronoBankAsset.sol')
const ChronoBankAssetWithFee = artifacts.require('chronobank-smart-contracts/build/contracts/ChronoBankAssetWithFee.sol')
const ChronoMint = artifacts.require('chronobank-smart-contracts/build/contracts/ChronoMint.sol')
const ContractsManager = artifacts.require('chronobank-smart-contracts/build/contracts/ContractsManager.sol')
